...
const COUNTS = [
  ...
  { value: "standard", label: "Standard (Standardeinstellung)" },
...
/** Per-option "Quiz anpassen" settings popup, opened from the quiz card chevron. */
export default function QuizSettingsModal({
  ...
  return (
    <ModalShell open={open} onClose={onClose} width={860}>
      ...
      >
        <Icon name="quiz" size={24} color="#056A95" fill={1} />
        <div style={{ flex: 1, ...studioTitle }}>Quiz anpassen</div>
      ...
      <div style={{ padding: "24px" }}>
        <div style={{ display: "flex", flexWrap: "wrap", gap: "22px 40px" }}>
          <div style={{ flex: 1, minWidth: 240 }}>
            <div style={{ ...studioLabel, marginBottom: 12 }}>Anzahl der Fragen</div>
